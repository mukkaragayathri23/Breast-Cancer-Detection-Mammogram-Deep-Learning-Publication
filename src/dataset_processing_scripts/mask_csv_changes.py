...
def main() -> None:
    ...
    """
    csv_mask_root_file = '/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM-mask/training.csv'
    csv_image_root_file = '/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/training.csv'

    csv_mask_root_file_testing = '/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM-mask/testing.csv'
    csv_image_root_file_testing = '/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/testing.csv'

    csv_output_path = '/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM-mask'  # csv output folder
