...
def main() -> None:
    ...
    :return: None
    """
    csv_path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM-mask/final_mask_training.csv"
    as_df = pd.read_csv(csv_path)
    
    f = open("/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM-mask/bbox_groud_truth.txt", "a")
