...
class CnnModel:
    ...
    def save_model(self) -> None:
        ...
        # Scratch space
        self._model.save(
            "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/saved_models/dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_{}_saved-model.h5".format(
                config.dataset,
    ...
    def save_weights(self) -> None:
        ...
        if self.model_name == "VGG-common" or self.model_name == "MobileNet":
            ...
            self._model.save_weights(
                "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/saved_models/dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_{}_all_weights.h5".format(
                    config.dataset,
                    config.mammogram_type,
                    config.model,
                    config.learning_rate,
            ...
            np.save(
                "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/saved_models/dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_{}_fc_weights.npy".format(
                    config.dataset,
                    config.mammogram_type,
                    config.model,
                    config.learning_rate,
    ...
    def load_minimias_weights(self) -> None:
        ...
        self._model.load_weights(
            "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/saved_models/dataset-mini-MIAS-binary_mammogramtype-all_model-MobileNet_lr-0.0001_b-2_e1-150_e2-50_roi-False__all_weights.h5"
        )
        # self._model.load_weights(
    ...
    def load_minimias_fc_weights(self) -> None:
        ...
        weights = np.load(
            "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/saved_models/dataset-mini-MIAS-binary_mammogramtype-all_model-MobileNet_lr-0.0001_b-2_e1-150_e2-50_roi-False__fc_weights.npy"
        )
        # weights = np.load(
