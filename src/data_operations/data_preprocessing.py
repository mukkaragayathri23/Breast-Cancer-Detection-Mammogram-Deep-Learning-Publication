...
def import_cbisddsm_training_dataset(label_encoder):
    ...
    if config.mammogram_type == "calc":
        cbis_ddsm_path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/calc-training.csv"
    elif config.mammogram_type == "mass":
        cbis_ddsm_path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/mass-training.csv"
    else:
        cbis_ddsm_path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/training.csv"
...
def import_cbisddsm_testing_dataset(label_encoder):
    ...
    cbis_ddsm_path = str()
    if config.mammogram_type == "calc":
        cbis_ddsm_path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/calc-test.csv"
    elif config.mammogram_type == "mass":
        cbis_ddsm_path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/mass-test.csv"
    else:
        cbis_ddsm_path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/testing.csv"
    df = pd.read_csv(cbis_ddsm_path)
    list_IDs = df['img_path'].values
    labels = encode_labels(df['label'].values, label_encoder)
    return list_IDs, labels
