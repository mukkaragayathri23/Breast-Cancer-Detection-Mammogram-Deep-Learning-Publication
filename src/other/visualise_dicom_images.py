...
def main() -> None:
    ...
    path = "/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/manifest-ZkhPvrLo5216730872708713142/CBIS-DDSM/Calc-Test_P_00038_LEFT_CC_1/08-29-2017-DDSM-NA-94942/1.000000-ROI mask images-18515/1-1.dcm"
    dataset = pydicom.dcmread(path)
    plt.imshow(dataset.pixel_array, cmap=plt.cm.bone)
    plt.savefig("/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/output/image_original.png")

    image = resize(dataset.pixel_array, [512, 512])
    imgplot = plt.imshow(image, cmap=plt.cm.bone)
    plt.savefig("/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/output/image_resized.png")

    # resize keep aspect ratio
    df = pd.read_csv("/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM/training.csv")
    ...
    plt.savefig("/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/output/image_maintained_AR.png")
