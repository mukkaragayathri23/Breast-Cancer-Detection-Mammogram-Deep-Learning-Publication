...
#     df = pd.read_csv("/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM-mask/final_mask_training.csv")
    
    df = pd.read_csv("/content/Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication/data/CBIS-DDSM-mask/shortened_mask_testing.csv")
